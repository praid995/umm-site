...
const Footer = () => {
  return (
    <footer className="bg-steel-900 text-white pt-16 pb-8 safe-area-padding">
      <div className="container-custom">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6 sm:col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-heading font-bold text-xl sm:text-2xl">УММ</span>
            </Link>
            ...
            <div className="flex flex-col space-y-3 text-sm sm:text-base text-gray-300">
              <a 
                href="tel:+78005553535" 
                className="flex items-center gap-3 hover:text-white transition-colors touch-target"
              >
                <Phone size={16} className="text-gray-400" />
                <span>+7 (800) 555-35-35</span>
              </a>
              <a 
                href="mailto:info@umm.ru" 
                className="flex items-center gap-3 hover:text-white transition-colors touch-target"
              >
          ...
          {/* Catalog */}
          <div>
            <h4 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Каталог</h4>
          ...
          {/* Services & Info */}
          <div>
            <h4 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Услуги и информация</h4>
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link 
                  href="/services/delivery" 
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Подпишитесь на рассылку</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Input 
                ...
                className="bg-steel-800 border-steel-700 text-white placeholder:text-gray-400 responsive-input"
              />
              <Button variant="default" className="responsive-button">
                <ArrowRight size={16} />
        ...
        <hr className="border-steel-700 my-8 sm:my-12" />
